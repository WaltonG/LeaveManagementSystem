 ...
 */
@Named(value = "cancelLeavesBacking")
@RequestScoped
public class CancelLeavesBacking {
    ...
    /**
     * Creates a new instance of CancelLeavesBacking
     */
    public CancelLeavesBacking() {
    }

    public DataModel<LeaveApplication> getLeaveApplications() {
        leaveApplications = new ListDataModel<LeaveApplication>(
                leaveApplicationAccessor.getStatusPending(login.getEmpid(), employeeAccessor.findEmployee(login.getEmpid()).getDepartment()));
